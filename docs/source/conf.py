...
# -*- coding: utf-8 -*-
#
# ipycallback documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipycallback', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipycallbackdoc'
...
latex_documents = [
    (master_doc, 'ipycallback.tex', 'ipycallback Documentation',
     'Binh Vu', 'manual'),
]
